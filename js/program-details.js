document.addEventListener("DOMContentLoaded", () => {
  const courseImages = {
    "Advanced Programming":"assets/images/programs/Advanced Programming.png",
    "Cloud Computing with AWS":"assets/images/programs/Cloud Computing with AWS.png",
    "Docker & Kubernetes":"assets/images/programs/Docker & Kubernetes.png",
    "Cloud & DevOps":"assets/images/programs/Cloud & DevOps.png",
    "AI & Machine Learning":"assets/images/programs/AI & Machine Learning.png",
    "Advanced Web & Software Development":"assets/images/programs/Advanced Web & Software Development.png",
    "Data Science & Analytics":"assets/images/programs/Data Science & Analytics.png",
    ...
    "Cloud & DevOps": "assets/images/all_programs/cloud-computing-with-aws.png",
    "SEO": "assets/images/all_programs/seo.png",
    "Financial Analytics": "assets/images/all_programs/financial-analysis.png",
  ...
  {
    module: "Module 1",
    title: "Advanced Programming Concepts & Problem Solving",
    topics: [
      "Advanced Programming Fundamentals, Logic Building & Computational Thinking",
      "Object-Oriented Programming, Abstraction, Encapsulation & Polymorphism",
      "Advanced Functions, Recursion, Exception Handling & Modular Programming",
      "Data Structures, Algorithms & Efficient Problem-Solving Techniques"
    ]
  },

  {
    module: "Module 2",
    title: "Advanced Algorithms & Software Development",
    topics: [
      "Advanced Searching, Sorting, Hashing & Algorithmic Techniques",
      "Trees, Graphs, Heaps, Linked Lists, Stacks & Queues",
      "Dynamic Programming, Greedy Algorithms, Backtracking & Optimization",
      "Clean Code, Design Patterns, Debugging & Software Engineering Practices"
    ]
  },

  {
    module: "Module 3",
    title: "Advanced Application Development & Performance",
    topics: [
      "Multithreading, Concurrency, Asynchronous Programming & Memory Management",
      "API Development, Database Integration & File Handling",
      "Performance Optimization, Testing, Profiling & Secure Coding",
      "Industry Capstone: Building a Scalable Software Application Using Advanced Programming Concepts"
    ]
  }
],
    ...
    "Cloud Computing with AWS": [
  {
    ...
    topics: [
      "Cloud Computing Concepts, AWS Global Infrastructure & Shared Responsibility Model",
      "AWS IAM, Users, Roles, Policies & Security Best Practices",
      "Amazon EC2, AMIs, Instance Types, EBS & Auto Scaling",
      "Amazon S3, Storage Classes, Lifecycle Policies & Data Management"
    ]
  },

  {
    ...
    topics: [
      "Amazon VPC, Subnets, Route Tables, Internet Gateways & Security Groups",
      "Amazon RDS, DynamoDB & Database Management on AWS",
      "Elastic Load Balancing, Route 53 & CloudFront",
  ...
  {
    module: "Module 3",
    title: "AWS DevOps, Security & Cloud Deployment",
    topics: [
      "AWS CloudFormation, Infrastructure as Code & Resource Automation",
      "CI/CD with AWS CodePipeline, CodeBuild & CodeDeploy",
      "CloudWatch, CloudTrail, AWS Security & Cost Optimization",
      "Industry Capstone: Designing, Deploying & Monitoring a Scalable Cloud Application on AWS"
    ]
  }
],
    ...
    "Docker & Kubernetes": [
  {
    ...
    topics: [
      "Containerization Concepts, Docker Architecture & Development Workflows",
      "Docker Images, Containers, Dockerfile & Image Optimization",
      "Docker Volumes, Networks, Environment Variables & Container Management",
  ...
  {
    module: "Module 2",
    title: "Kubernetes Fundamentals & Application Orchestration",
    topics: [
      ...
      "Application Scaling, Rolling Updates, Rollbacks & Resource Management"
    ]
  },

  {
    module: "Module 3",
    title: "Production Kubernetes, DevOps & Cloud Deployment",
    topics: [
      "Ingress, Load Balancing, Networking & Kubernetes Security",
      "Helm Charts, Kubernetes Operators & Application Configuration",
      "CI/CD Integration, Monitoring, Logging & Production Troubleshooting",
      "Industry Capstone: Containerizing and Deploying a Production-Ready Application on Kubernetes"
    ]
  }
],
    ...
    "Cloud & DevOps": [
  {
    ...
    topics: [
      ...
      "AWS/Azure Fundamentals, Virtual Machines, Storage & Networking",
      "Linux, Shell Scripting & Cloud Resource Management",
      "Identity, Access Management, Security & Cloud Cost Optimization"
    ]
  },

  {
    module: "Module 2",
    title: "DevOps, Containers & Continuous Integration",
    topics: [
      "DevOps Culture, Lifecycle, Version Control & Git/GitHub Workflows",
      "Docker, Containerization, Images, Networks & Volumes",
      "CI/CD Pipelines, Automated Builds, Testing & Deployment",
      "Infrastructure as Code with Terraform & Configuration Management"
    ]
  },

  {
    module: "Module 3",
    title: "Kubernetes, Cloud Deployment & DevOps Automation",
    topics: [
      "Kubernetes Architecture, Pods, Services, Deployments & Scaling",
      "Cloud-Native Applications, Microservices & Serverless Computing",
      "Monitoring, Logging, Observability & Production Troubleshooting",
      "Industry Capstone: Building and Deploying a Scalable Cloud-Native Application with CI/CD"
    ]
  }
],
  ...
  {
    module: "Module 1",
    title: "Artificial Intelligence & Machine Learning Foundations",
    topics: [
      "AI Fundamentals, Machine Learning Concepts & Intelligent Systems",
...

  {
    ...
    topics: [
      ...
      "K-Nearest Neighbors, Support Vector Machines & Ensemble Learning",
      "Clustering, Dimensionality Reduction & Recommendation Systems",
      "Model Evaluation, Cross-Validation, Hyperparameter Tuning & Optimization"
    ]
  },

  {
    module: "Module 3",
    title: "Advanced AI, Deep Learning & Model Deployment",
    topics: [
      "Neural Networks, Deep Learning & Representation Learning",
      "Natural Language Processing, Computer Vision & Generative AI",
      "Model Deployment, MLOps, APIs & Production Machine Learning",
      "Industry Capstone: Building, Deploying & Evaluating an End-to-End AI/ML Solution"
    ]
  }
],
  ...
  {
    module: "Module 1",
    title: "Data Science Foundations & Data Analysis",
    topics: [
      "Data Science Fundamentals, Analytical Thinking & Problem Solving",
      "Python for Data Science, NumPy, Pandas & Data Manipulation",
      "Data Cleaning, Preprocessing, Missing Values & Outlier Treatment",
      "Exploratory Data Analysis, Statistical Analysis & Pattern Discovery"
    ]
  },

  {
    module: "Module 2",
    title: "Data Visualization & Statistical Modeling",
    topics: [
      "Data Visualization with Matplotlib, Seaborn & Interactive Visualization",
      ...
      "Business Intelligence, KPI Analysis & Data-Driven Decision Making"
    ]
  },

  {
    module: "Module 3",
    title: "Machine Learning, Analytics & Real-World Applications",
    topics: [
      "Machine Learning Fundamentals, Supervised & Unsupervised Learning",
      "Regression, Classification, Clustering & Model Evaluation",
      "Predictive Analytics, Model Optimization & Insight Generation",
      "Industry Capstone: Building an End-to-End Data Science & Analytics Solution"
    ]
  }
],
  ...
  {
    module: "Module 1",
    title: "Modern Web Development & Application Architecture",
    topics: [
      "Advanced HTML5, CSS3, JavaScript & Modern Web Standards",
      "Responsive Design, Component-Based Development & Web Accessibility",
      "Frontend Architecture, State Management & API Integration",
      "Web Performance, Security Fundamentals & Optimization"
    ]
  },

  {
    module: "Module 2",
    title: "Full-Stack Development & Backend Engineering",
    topics: [
      "React.js, Node.js, Express.js & Modern Full-Stack Development",
      "REST APIs, Authentication, Authorization & Secure Application Design",
      "Database Integration with SQL & NoSQL Databases",
      "Git, GitHub, Version Control & Collaborative Software Development"
    ]
  },

  {
    module: "Module 3",
    title: "Advanced Software Engineering & Deployment",
    topics: [
      "Software Architecture, Design Patterns & Scalable Application Development",
      "Testing, Debugging, Error Handling & Code Quality Practices",
      "Docker, CI/CD, Cloud Deployment & Application Monitoring",
      "Industry Capstone: Building and Deploying a Production-Ready Full-Stack Application"
    ]
  }
],
